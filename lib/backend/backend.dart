...
import 'schema/token_record.dart';
...
export 'schema/token_record.dart';
...
/// Functions to query TokenRecords (as a Stream and as a Future).
Stream<List<TokenRecord>> queryTokenRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<TokenRecord>> queryTokenRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<TokenRecord>> queryTokenRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
