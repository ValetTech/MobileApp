...
class _ReservationsWidgetState extends State<ReservationsWidget> {
  ...
  ValueNotifier<List<String>?> choiceChipsValues1 = ValueNotifier(null);
  ValueNotifier<List<String>?> choiceChipsValues2 = ValueNotifier(null);
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          'Filter by sitting or seating area',
                                        ...
                                        if (FFAppState().filtersOn == true)
                                          InkWell(
                                            onTap: () async {
                                              setState(() => choiceChipsValues1
                                                  .value = []);
                                              setState(() => choiceChipsValues2
                                                  .value = []);
                                              setState(() => FFAppState()
                                                  .filtersOn = false);
                                            },
                            ...
                            child: Container(
                              ...
                              child: FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Builder(
                                    builder: (context) {
                                      final reservation = GETReservationsCall
                                          .byBreakfastSitting(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        functions
                                                                            .formatReservationTime(getJsonField(
                                                                          reservationItem,
                                                                          r'''$.dateTime''',
                                                                        ).toString()),
                                                                        style: FlutterFlowTheme.of(context)
